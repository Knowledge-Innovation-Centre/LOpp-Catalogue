...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"EPj1":[function(require,module,exports) {

},{}],"FPxS":[function(require,module,exports) {

},{"./wordpress.pcss":"EPj1","./react-notifications.pcss":"EPj1"}],"d9r0":[function(require,module,exports) {
module.exports = {
  "react-notifications": require("./react-notifications.pcss"),
  "style": require("./style.pcss"),
  "wordpress": require("./wordpress.pcss")
};
},{"./react-notifications.pcss":"EPj1","./style.pcss":"FPxS","./wordpress.pcss":"EPj1"}],"QPfz":[function(require,module,exports) {
...
},{"regenerator-runtime":"QVnC"}],"EDTP":[function(require,module,exports) {
'use strict';
...
var _default = Api;
exports.default = _default;
},{"axios":"dZBD"}],"Ddjh":[function(require,module,exports) {
"use strict";
...
var _Api = _interopRequireDefault(require("../../../Common/js/Api"));
...
var _default = {
  ...
  created: function created() {},
  methods: {
    runUploader: function runUploader(event) {
      event.preventDefault();
      var $this = this;
      var frame = this.openFrame(); // When an image is selected in the media frame...
    ...
    runUploader1: function runUploader1(event) {
      event.preventDefault();
      var $this = this;
      var frame = this.openFrame(); // When an image is selected in the media frame...
    ...
    openFrame: function openFrame() {
      ...
      var $this = this; // Create a new media frame
    ...
    runImporterCatalog: function runImporterCatalog(event) {
      event.preventDefault();
      this.runImport(this.attachments, "loc_catalog_import_xml");
    },
    runImporterMaturity: function runImporterMaturity(event) {
      event.preventDefault();
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _this.imported = 0;
                _this.notImported = 0;
                _this.failedImportAttachments = [];
                _iterator = _createForOfIteratorHelper(attachments);
                _context2.prev = 5;
                _loop = /*#__PURE__*/_regenerator.default.mark(function _loop() {
                  var attachment, formData, response;
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          _context.next = 6;
                          return _Api.default.post(ajaxurl, formData, {
                            processData: false,
                            contentType: false
...
exports.default = _default;
        var $45e85b = exports.default || module.exports;
      
      if (typeof $45e85b === 'function') {
        $45e85b = $45e85b.options;
      }
    
        /* template */
        Object.assign($45e85b, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container"},[_c('notifications'),_vm._v(" "),_c('h1',{staticClass:"my-2 text-2xl"},[_vm._v(_vm._s(_vm.$t('Import catalog items and learning maturity models')))]),_vm._v(" "),_c('div',{staticClass:"grid grid-cols-2 gap-5"},[_c('div',[_c('button',{staticClass:"bg-blue-600 p-3 text-white",on:{"click":_vm.runUploader}},[_vm._v("\n        "+_vm._s(_vm.$t('Select Catalog XML'))+"\n      ")]),_vm._v("\n\n      "+_vm._s(_vm.$t('Selected files:'))+"\n      "),(!_vm.attachments.length)?_c('div',[_vm._v(_vm._s(_vm.$t('No files selected')))]):_vm._e(),_vm._v(" "),_vm._l((_vm.attachments),function(attachment){return _c('div',{staticClass:"mt-5",class:_vm.failedImportAttachmentIds.includes(attachment.id) ? 'text-red-500' : ''},[_vm._v("\n         "+_vm._s(attachment.name)+"\n      ")])}),_vm._v(" "),_c('div',[_c('button',{staticClass:"bg-blue-600 p-3 text-white mt-5",on:{"click":_vm.runImporterCatalog}},[_vm._v("\n          "+_vm._s(_vm.$t('Import Catalog'))+"\n\n        ")])])],2),_vm._v(" "),_c('div',[_c('button',{staticClass:"bg-blue-600 p-3 text-white",on:{"click":_vm.runUploader1}},[_vm._v("\n        "+_vm._s(_vm.$t('Select learning maturity model XML'))+"\n      ")]),_vm._v(" "),_vm._l((_vm.attachmentsLearningMaturity),function(attachmentLearningMaturity){return _c('div',{staticClass:"mt-5"},[_vm._v("\n        "+_vm._s(_vm.$t('Selected files:'))+" "+_vm._s(attachmentLearningMaturity.name)+"\n      ")])}),_vm._v(" "),_c('div',[_c('button',{staticClass:"bg-blue-600 p-3 text-white mt-5",on:{"click":_vm.runImporterMaturity}},[_vm._v("\n          "+_vm._s(_vm.$t('Import learning maturity model'))+"\n\n        ")])])],2)]),_vm._v(" "),_c('div',{staticClass:"mt-5"},[_vm._v(_vm._s(_vm.$t('Imported:'))+" "+_vm._s(_vm.imported))]),_vm._v(" "),_c('div',{staticClass:"mt-5"},[_vm._v(_vm._s(_vm.$t('Failed to imported:'))+" "+_vm._s(_vm.notImported))]),_vm._v(" "),_c('div',{staticClass:"mt-5"},[_vm._v(_vm._s(_vm.$t('Progress:'))+" "+_vm._s(_vm.progress)+"%")])],1)}
var staticRenderFns = []
...
},{"@babel/runtime/helpers/asyncToGenerator":"agGE","@babel/runtime/regenerator":"PMvg","../../../Common/js/Api":"XPwX","vue":"QPfz"}],"E8ZC":[function(require,module,exports) {
var define;
...
},{"vue":"QPfz"}],"hAXC":[function(require,module,exports) {
"use strict";
...
},{"vue":"QPfz","./App.vue":"Ddjh","vue-notification":"E8ZC"}],"b5MT":[function(require,module,exports) {
"use strict";

var _ = _interopRequireDefault(require("../src/Admin/Settings/pcss/*.pcss"));

var _index = _interopRequireDefault(require("../src/Admin/Settings/js/index.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"../src/Admin/Settings/pcss/*.pcss":"d9r0","../src/Admin/Settings/js/index.js":"hAXC"}]},{},["b5MT"], null)