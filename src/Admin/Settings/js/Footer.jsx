		...
		<footer className="container">
			<div>
				...
				<Button
					isSecondary
					target="_blank"
					href="https://wordpress.org/support/plugin/learning-opportunities-catalogue"
				>
				...
				<Button
					isSecondary
					target="_blank"
					href="https://wordpress.org/support/plugin/learning-opportunities-catalogue/reviews/?rate=5#new-post"
				>
