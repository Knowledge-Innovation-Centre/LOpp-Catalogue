...
namespace LearningOpportunitiesCatalogue\Admin\Settings;

use LearningOpportunitiesCatalogue\Common\Settings\Choices;
use LearningOpportunitiesCatalogue\Common\Settings\Customizer;
...
if ( ! class_exists( Main::class ) ) {
	...
	class Main {
		...
		public function add_plugin_admin_menu(): void {
			add_menu_page( PluginData::get_plugin_display_name(), PluginData::get_plugin_display_name(), $this->common->required_capability(), $this->settings->get_settings_page_slug(), [
				$this,
				'settings_page'
			] );
			...
			$hook_suffix = add_submenu_page(
				$this->settings->get_settings_page_slug(),
				esc_html__( 'Importer', 'learning-opportunities-catalogue' ),
				esc_html__( 'Importer', 'learning-opportunities-catalogue' ),
				$this->common->required_capability(),
				$this->settings->get_importer_page_slug(),
				[ $this, 'importer_page' ]
			);
			...
			wp_localize_script(
				...
				[
					...
					'optionsInfo'   => [
						 ...
						 *
						 * @see \LearningOpportunitiesCatalogue\Common\Settings\Main::get_option_prefix()
						 */
