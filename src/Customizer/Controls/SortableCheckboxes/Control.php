...
namespace LearningOpportunitiesCatalogue\Customizer\Controls\SortableCheckboxes;
...
if ( ! class_exists( Control::class ) ) {
	...
	class Control extends WP_Customize_Control {
		...
		/**
		 * Get the script or style handle, like `learning-opportunities-catalogue-sortable_checkboxes-js`.
		 *
		 * @param string $suffix
		 *
		 * @return string
