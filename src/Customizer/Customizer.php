...
namespace LearningOpportunitiesCatalogue\Customizer;

use WP_Customize_Manager;
use LearningOpportunitiesCatalogue\Common\Common;
use LearningOpportunitiesCatalogue\Common\Settings\Choices;
use LearningOpportunitiesCatalogue\Common\Settings\Customizer as Settings;
use LearningOpportunitiesCatalogue\Customizer\Controls\SortableCheckboxes\Control;
		...
		public function customizer_options( WP_Customize_Manager $wp_customize ): void {
			...
			$wp_customize->add_panel(
				...
				[
					...
					'description' => esc_html__( 'Plugin options and settings', 'learning-opportunities-catalogue' ) . $this->settings->get_link_to_customizer_panel(),
				]
			);
			...
			$wp_customize->add_section(
				...
				[
					'title'       => esc_html__( 'Example Section', 'learning-opportunities-catalogue' ),
					'description' => esc_html__( 'Example Section description.', 'learning-opportunities-catalogue' ),
		...
		private function add_setting_social_networks( WP_Customize_Manager $wp_customize, string $section_slug, string $setting_slug ): void {
			...
			$wp_customize->add_control(
				new Control(
					...
					[
						'label'       => esc_html__( 'Social Network(s)', 'learning-opportunities-catalogue' ),
						'description' => esc_html__( 'Checked ones will output; unchecked ones will not. Drag and drop to set your preferred display order.', 'learning-opportunities-catalogue' ),
		...
		private function add_setting_post_types( WP_Customize_Manager $wp_customize, string $section_slug, string $setting_slug ): void {
			...
			$wp_customize->add_control(
				new Control(
					...
					PluginData::plugin_text_domain_underscores() . '_' . $setting_slug . '_control',
					[
						'label'       => esc_html__( 'Post Type(s)', 'learning-opportunities-catalogue' ),
						'description' => esc_html__( 'Which Post Types should be enabled?', 'learning-opportunities-catalogue' ),
						'section'     => $this->get_section_id( $section_slug ),
						'settings'    => $this->get_setting_id( $setting_slug ),
