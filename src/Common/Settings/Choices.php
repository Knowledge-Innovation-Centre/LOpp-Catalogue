...
namespace LearningOpportunitiesCatalogue\Common\Settings;

use LearningOpportunitiesCatalogue\Common\Utilities as Utils;
	...
	class Choices {
		...
		public function get_social_networks_data( $retrieve = '' ): array {
			$networks = [
				[
					'key'   => 'facebook',
					'name'  => esc_html__( 'Facebook', 'learning-opportunities-catalogue' ),
					'color' => '#3b5998',
				],
				[
					'key'   => 'twitter',
					'name'  => esc_html__( 'Twitter', 'learning-opportunities-catalogue' ),
					'color' => '#00aced',
				],
				[
					'key'   => 'pinterest',
					'name'  => esc_html__( 'Pinterest', 'learning-opportunities-catalogue' ),
					'color' => '#BD081C',
				],
				[
					'key'   => 'linkedin',
					'name'  => esc_html__( 'LinkedIn', 'learning-opportunities-catalogue' ),
					'color' => '#007bb6',
				],
			];
