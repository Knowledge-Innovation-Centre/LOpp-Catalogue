 ...
 *
 * @see \LearningOpportunitiesCatalogue\Shortcodes\Manage::$shortcode_classes Manually add your child class name here to get it to load.
 */
abstract class Shortcode {
	...
	public function get_error_message_to_user_with_cap( string $cause ): string {
		if (
			...
			$cause = esc_html_x( 'Unspecified', 'Shortcode error cause default text', 'learning-opportunities-catalogue' );
		}
