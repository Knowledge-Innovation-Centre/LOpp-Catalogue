...
if ( ! class_exists( PluginData::class ) ) {
	...
	class PluginData {
		...
		public static function plugin_text_domain(): string {
			return 'learning-opportunities-catalogue';
		}
		 ...
		 *
		 * @return string 'learning_opportunities_catalogue'
		 */
		...
		public static function get_plugin_display_name(): string {
			return esc_html_x( 'Learning Opportunities Catalogue', 'Plugin name for display', 'learning-opportunities-catalogue' );
		}
		 ...
		 * Example: /app/public/wp-content/plugins/learning-opportunities-catalogue/
		 *
		 * @return string
		 */
		 ...
		 *
		 * Example: https://example.com/wp-content/plugins/learning-opportunities-catalogue/
		 *
		 * @return string
		 */
		 ...
		 *
		 * @return string 'learning-opportunities-catalogue/learning-opportunities-catalogue.php'
		 */
